...
for inexptime in [60, 180, 300, 600, 900]:
	...
	# %%
	def func(x, z, t, Rph0, Tvis, b, bhmass, eff, lphoto, starmass,):

		new_data = np.array(
			[[Rph0, Tvis, b, bhmass, eff, lphoto, starmass, t]]
			)
	...
	for ii, intable in enumerate(intablelist[:100]):
		...
		if detection:
			...
			if fit:
				...
				z, t, Rph0, Tvis, b, bhmass, eff, lphoto, starmass = bestfit_values
